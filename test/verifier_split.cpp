...
TEST_CASE( "SPLIT: System with an unsafe initial state" )
{
...
TEST_CASE( "SPLIT: Unsafe when input is true in the initial state" )
{
...
TEST_CASE( "SPLIT: Unsafe when input is false in the initial state" )
{
...
TEST_CASE( "SPLIT: Unsafe state reached in one step" )
{
...
TEST_CASE( "SPLIT: Unsafe four state system" )
{
    // 0 0 -> 1 0
    //  v      v
    // 0 1 -> 1 1
...
TEST_CASE( "SPLIT: Trivially safe four state system" )
{
    const auto* const str =
                "aag 10 1 2 1 7\n"
                "2\n"         // i
...
TEST_CASE( "SPLIT: Unsafe state is not reachable in a two state system" )
{
...
TEST_CASE( "SPLIT: Simple unsafe HWMCC benchmark" )
{
...
TEST_CASE( "SPLIT: Simple safe HWMCC benchmark" )
{
